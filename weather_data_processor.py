...
class WeatherDataProcessor:
    def __init__(self, config_params, logging_level="INFO"):
        """
        Initialize the WeatherDataProcessor class.
    ...
    def initialize_logging(self, logging_level):
        """
        Initialize logging for the WeatherDataProcessor.
    ...
    def weather_station_mapping(self):
        """
        Load weather station data from the web and assign it to weather_df.
        """
    ...
    def extract_measurement(self, message):
        """
        Extract measurement from the message using regex patterns.

        Parameters:
        message (str): Input message.

        Returns:
        tuple: Measurement key and value extracted from the message.
        """
    ...
    def process_messages(self):
        """
        Process messages in the weather_df to extract measurements.
        """
    ...
    def calculate_means(self):
        """
        Calculate means of measurements grouped by weather station ID and measurement type.
        """
        if self.weather_df is not None:
